export const config = {
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "KjZItRY2cFkcNKO6nkuuqiXWwObyhDc3YJKq_ypOWSM",
      // 所在省份
      province: "浙江",
      // 所在城市
      city: "杭州",
    ...
    },
    {
      ...
      useTemplateId: "iezIf72rZYWMyZTgOVZfq_lQdOFy8Gak_ArYVzb1OQE",
      province: "浙江",
      city: "杭州",
      horoscopeDate: '08-13',
      horoscopeDateType: '今日',
  ...
  FESTIVALS: [
    ...
    {"type": "节日", "name": "平安夜", "year": "2022", "date": "12-24"},
